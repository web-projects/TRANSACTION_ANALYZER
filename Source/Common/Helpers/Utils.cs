...
namespace Common.Helpers
{
    ...
    {
        public const int DeviceHealthKeyValueLength = 40;
        public const char DeviceHealthKeyValuePaddingCharacter = '_';
        public const int DeviceLogKeyValueLength = 39;
        ...
        public static string Split(string str, int chunkSize, char separator)
            => $"[{string.Join(separator, Split(str, chunkSize))}]";
